	...
	class Van_02_transport_base_F: Van_02_base_F {
		...
		class UserActions {
			...
			class open_driver_door: door_action {
				...
				displayName = "Open Driver Door";
				available = 1;
				condition = "(this animationPhase 'Door_1_source' == 0) && ((player distance2D (this modelToWorld [-1,2.2,-1])) < 2) && ((this getCargoIndex player) != 0) && ((this getCargoIndex player) != 8)";
				statement = "this animateDoor ['Door_1_source', 1,false];";
			};
			...
			class close_driver_door: door_action {
				...
				displayName = "Close Driver Door";
				available = 1;
				condition = "(this animationPhase 'Door_1_source' == 1) && ((player distance2D (this modelToWorld [-1,2.2,-1])) < 2) && ((this getCargoIndex player) != 0) && ((this getCargoIndex player) != 8)";
				statement = "this animateDoor ['Door_1_source', 0,false];";
			};
			...
			class open_side_door: door_action {
				...
				displayName = "Open Side Door";
				available = 1;
				condition = "(this animationPhase 'Door_3_source' == 0) && ((player distance2D (this modelToWorld [1,1,-1])) < 2) && (driver this != player) && ((this getCargoIndex player) != 0) && ((this getCargoIndex player) != 8)";
				statement = "this animateDoor ['Door_3_source', 1,false];";
			};
			...
			class close_side_door: door_action {
				...
				displayName = "Close Side Door";
				available = 1;
				condition = "(this animationPhase 'Door_3_source' == 1) && ((player distance2D (this modelToWorld [1,1,-1])) < 2) && (driver this != player) && ((this getCargoIndex player) != 0) && ((this getCargoIndex player) != 8)";
				statement = "this animateDoor ['Door_3_source', 0,false];";
			};
			...
			class open_back_door: door_action {
				...
				displayName = "Open Back Door";
				available = 1;
				condition = "(this animationPhase 'Door_4_source' == 0) && ((player distance2D (this modelToWorld [0,-3,-1])) < 2) && ((this getCargoIndex player) != 9) && ((this getCargoIndex player) != 10)";
				statement = "this animateDoor ['Door_4_source', 1,false];";
			};
			...
			class close_back_door: door_action {
				...
				displayName = "Close Back Door";
				available = 1;
				condition = "(this animationPhase 'Door_4_source' == 1) && ((player distance2D (this modelToWorld [0,-3,-1])) < 2) && ((this getCargoIndex player) != 9) && ((this getCargoIndex player) != 10)";
				statement = "this animateDoor ['Door_4_source', 0,false];";
			};
		};
	};
