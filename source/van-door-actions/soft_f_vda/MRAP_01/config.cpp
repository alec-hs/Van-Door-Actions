	...
	class MRAP_01_base_F {
		...
		class UserActions {
			...
			class open_driver_door: door_action {
				...
				available = 1;
				condition = "(this animationPhase 'Door_LF' == 0) && ((player distance2D (this modelToWorld [-1,2.2,-1])) < 2) && ((this getCargoIndex player) != 0)";
			...
			class close_driver_door: door_action {
				...
				available = 1;
				condition = "(this animationPhase 'Door_LF' == 1) && ((player distance2D (this modelToWorld [-1,2.2,-1])) < 2) && ((this getCargoIndex player) != 0)";
